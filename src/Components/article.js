  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      ...
      { opacity: 0, y: -50 },
      {
        ...
        ease: "power3.out",
        scrollTrigger: {
          trigger: "h1",  // Trigger animation when the heading comes into view
          start: "top 80%",  // Animation starts when the top of the heading is at 80% of the viewport height
          toggleActions: "play none none reverse",
        }
      }
    );

    // Animate the article image container
    gsap.fromTo(
      ...
      { opacity: 0, y: 100 },
      {
        ...
        ease: "power3.out",
        scrollTrigger: {
          trigger: ".article-image-container",  // Trigger when the image container comes into view
